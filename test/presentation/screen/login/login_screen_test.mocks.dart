...
class MockLoginBloc extends _i1.Mock implements _i2.LoginBloc {
  ...
  @override
  _i6.Stream<_i2.LoginState> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i6.Stream<_i2.LoginState>.empty(),
  ...
  @override
  void onTransition(
          _i7.Transition<_i2.LoginEvent, _i2.LoginState>? transition) =>
      super.noSuchMethod(
        Invocation.method(
          #onTransition,
          [transition],
...
class MockAccountBloc extends _i1.Mock implements _i3.AccountBloc {
  ...
  @override
  _i6.Stream<_i3.AccountState> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i6.Stream<_i3.AccountState>.empty(),
  ...
  @override
  void onTransition(
          _i7.Transition<_i3.AccountEvent, _i3.AccountState>? transition) =>
      super.noSuchMethod(
        Invocation.method(
          #onTransition,
          [transition],
...
class MockRegisterBloc extends _i1.Mock implements _i5.RegisterBloc {
  ...
  @override
  _i5.RegisterState get state => (super.noSuchMethod(
        Invocation.getter(#state),
        returnValue: _FakeRegisterState_3(
          this,
          Invocation.getter(#state),
        ),
  ...
  @override
  _i6.Stream<_i5.RegisterState> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i6.Stream<_i5.RegisterState>.empty(),
  ...
  @override
  void onTransition(
          _i7.Transition<_i5.RegisterEvent, _i5.RegisterState>? transition) =>
      super.noSuchMethod(
        Invocation.method(
          #onTransition,
          [transition],
  ...
  @override
  void add(_i5.RegisterEvent? event) => super.noSuchMethod(
        Invocation.method(
          #add,
          [event],
        ),
  ...
  @override
  void onEvent(_i5.RegisterEvent? event) => super.noSuchMethod(
        Invocation.method(
          #onEvent,
          [event],
        ),
  ...
  @override
  void emit(_i5.RegisterState? state) => super.noSuchMethod(
        Invocation.method(
          #emit,
          [state],
        ),
  ...
  @override
  void onChange(_i7.Change<_i5.RegisterState>? change) => super.noSuchMethod(
        Invocation.method(
          #onChange,
          [change],
        ),
...
class MockAppLocalStorage extends _i1.Mock implements _i8.AppLocalStorage {
  ...
  @override
  void setStrategy(_i8.StorageType? type) => super.noSuchMethod(
        Invocation.method(
          #setStrategy,
          [type],
        ),
